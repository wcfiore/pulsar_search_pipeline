...
output += '    candnum=$1\n'
output += '    DM=$2\n\n'
output += '    prepfold -noxwin -accelcand $1 -accelfile ${inffilepath}/${basename}_DM$2_ACCEL_${zmax}.cand -dm $2 -mask ${rfipath}/${maskfile} ${datapath}/${datafiles} -o ${resultspath}/${outfilebase}_raw_DM$2\n\n'
output += '}\n\n'
